  ...
  <div class="modal-dialog modal-lg" role="document">
    <div style="z-index: 99999;" class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><?php _e('Import mapping from bug', $this->plugin);?></h5>
      ...
      <div class="modal-body form px-4">
        <div class="modal-form pb-4">
          <input class="form-control" type="text" id="issue_id" placeholder="<?php _e('Search for a bug (Eg. ABC-01)', $this->plugin); ?>" />
        </div>
        <div class="row">
